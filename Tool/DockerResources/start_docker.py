...
class DockerComposeEnvironment:
    def __init__(self, services = None):
        self.services = ["Device_Registry", "Service_Server", "Dashboard"]
        self.default_docker_compose_files = ["/app/Tool/DockerResource/docker-compose.yaml"]
...
if __name__ == "__main__":
    print("Run Docker Environment")
    #services = ["Device_Registry", "Service_Server", "Dashboard"]
    DockerComposeEnvironment().start_docker_compose()