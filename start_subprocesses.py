...
# # sys.path.append(os.path.join(os.path.dirname(__file__), "swap-it-execution-engine/."))
# # sys.path.append(os.path.join(os.path.dirname(__file__), "swap-it-execution-engine/PFDL_Examples/."))
# # sys.path.append(os.path.join(os.path.dirname(__file__), "swap-it-execution-engine/"))
...
# def start_ee(ctr, url="opc.tcp://localhost:400"):
#     try:
#         print("Aktuelles Arbeitsverzeichnis2: ", os.getcwd())
#         cmd = [
#             #"../../bin/python3", "./../swap-it-execution-engine/main.py",
#             #"python3", "./../swap-it-execution-engine/main.py",
#             "python3", "/app/swap-it-execution-engine/main.py",
#             f"{url}{ctr}",
#             "/app/swap-it-execution-engine/PFDL_Examples/advanced.pfdl",
#             #"./../swap-it-execution-engine/PFDL_Examples/advanced.pfdl",
#             "dashboard_host_address=http://host.docker.internal:8080",
#             "log_info=True",
#             "device_registry_url=opc.tcp://host.docker.internal:8000",
#             "custom_url=opc.tcp://host.docker.internal:",
#             "number_default_clients=5"
#         ]
#         print("start the execution engine with \n")
#         print(cmd)
...
#     # Temporäres Arbeitsverzeichnis setzen
#     #os.chdir('../swap-it-execution-engine')
#     #print("Aktuelles Arbeitsverzeichnis: ", os.getcwd())

#     if len(sys.argv) != 2:
#         print("Usage: python3 script.py <inner_loops>", file=sys.stderr)
#         sys.exit(1)
...
#         try:
#             thread = threading.Thread(target=start_ee, args=(i,))
#             thread.start()
#             threads.append(thread)
#             time.sleep(3)  # Verhindert, dass Threads zu schnell hintereinander starten
#         except Exception as e:
...
# finally:
#     # Zum ursprünglichen Arbeitsverzeichnis zurückkehren
